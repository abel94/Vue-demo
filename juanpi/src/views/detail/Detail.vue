<template>
  <div class="detail-wrap">
    <div class="detail-content" v-if="productItem.oprice" >
      <div class="detail-banner swiper-container">
        ...
        <span class="detail-back" @click="detailBack()">
          <svg
            t="1562475657652"
            class="icon"
      ...
      <div class="pro-store">
        <img :src="productItem.schedule_info.logo_url" />
    ...
    <nav>
      <ul>
        ...
        <li>立即购买</li>
        <li class="go-carts" @click="putProductToCart(id)">加入购物车</li>
      </ul>
    </nav>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    ...mapActions({
      putProductToCart: "cart/putProductToCart"
    })
  }
};
</script>
